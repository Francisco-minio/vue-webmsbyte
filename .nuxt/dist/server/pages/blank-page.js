...
var add = __webpack_require__(6).default
module.exports.__inject__ = function (context) {
  add("01d7414f", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_blank_page_vue_vue_type_style_index_0_id_142746ce_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(274);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_blank_page_vue_vue_type_style_index_0_id_142746ce_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_blank_page_vue_vue_type_style_index_0_id_142746ce_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_blank_page_vue_vue_type_style_index_0_id_142746ce_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_blank_page_vue_vue_type_style_index_0_id_142746ce_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".use-text-title[data-v-142746ce]{font-weight:var(--font-bold);font-size:48px;line-height:72px}@media(max-width:1279px){.use-text-title[data-v-142746ce]{font-size:38px;line-height:60px}}@media(max-width:599px){.use-text-title[data-v-142746ce]{font-size:28px;line-height:44px}}.use-text-title2[data-v-142746ce]{font-size:36px;line-height:56px;font-weight:var(--font-bold)}@media(max-width:1279px){.use-text-title2[data-v-142746ce]{font-size:32px;line-height:48px}}@media(max-width:599px){.use-text-title2[data-v-142746ce]{font-size:24px;line-height:36px}}.use-text-subtitle[data-v-142746ce]{font-weight:var(--font-medium);font-size:28px;line-height:44px}@media(max-width:1279px){.use-text-subtitle[data-v-142746ce]{font-size:24px;line-height:36px}}@media(max-width:599px){.use-text-subtitle[data-v-142746ce]{font-size:18px;line-height:28px}}.use-text-subtitle2[data-v-142746ce]{font-weight:var(--font-regular);font-size:22px;line-height:32px}@media(max-width:1279px){.use-text-subtitle2[data-v-142746ce]{font-size:20px;line-height:32px}}@media(max-width:599px){.use-text-subtitle2[data-v-142746ce]{font-size:16px;line-height:24px}}.use-text-caption[data-v-142746ce],.use-text-paragraph[data-v-142746ce]{font-weight:var(--font-regular);font-size:16px;line-height:24px}@media(max-width:599px){.use-text-caption[data-v-142746ce]{font-size:14px;line-height:22px}}@media(max-width:1919px){.use-hidden-lg-down[data-v-142746ce]{display:none}}@media(max-width:1279px){.use-hidden-md-down[data-v-142746ce]{display:none}}@media(max-width:959px){.use-hidden-sm-down[data-v-142746ce]{display:none}}@media(max-width:599px){.use-hidden-xs-down[data-v-142746ce]{display:none}}@media(min-width:1280px){.use-hidden-lg-up[data-v-142746ce]{display:none}}@media(min-width:960px){.use-hidden-md-up[data-v-142746ce]{display:none}}@media(min-width:600px){.use-hidden-sm-up[data-v-142746ce]{display:none}}.main-wrap[data-v-142746ce]{position:relative;width:100%;overflow:hidden}.theme--light .main-wrap[data-v-142746ce]{color:rgba(0,0,0,.87)}.theme--dark .main-wrap[data-v-142746ce]{color:#fff;background-color:#303030}.theme--light .main-wrap[data-v-142746ce]{background-color:#fff}.space-bottom[data-v-142746ce]{margin-bottom:160px}.space-top[data-v-142746ce]{margin-top:160px}.container-wrap[data-v-142746ce]{margin-top:80px;padding:32px}.container-wrap>section[data-v-142746ce]{position:relative}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/blank-page.vue?vue&type=template&id=142746ce&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<section id=\"home\" data-v-142746ce></section> "),_vm._ssrNode("<div class=\"main-wrap\" data-v-142746ce>","</div>",[_c('main-header',{attrs:{"invert":""}}),_vm._ssrNode(" <div class=\"container-wrap\" data-v-142746ce><section class=\"space-top space-bottom\" data-v-142746ce><h2 class=\"display-3 text-center mb-4\" data-v-142746ce>"+_vm._ssrEscape("\n          "+_vm._s(_vm.$t('common.title'))+"\n        ")+"</h2> <h4 class=\"display-1 text-center\" data-v-142746ce>"+_vm._ssrEscape("\n          "+_vm._s(_vm.$t('common.subtitle'))+"\n        ")+"</h4></section></div> "),_vm._ssrNode("<section class=\"spaceTop\" data-v-142746ce>","</section>",[_c('main-footer',{attrs:{"invert":""}})],1),_vm._ssrNode(" "),_c('notification')],2)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/blank-page.vue?vue&type=template&id=142746ce&scoped=true&
...
/* harmony default export */ var blank_pagevue_type_script_lang_js_ = ({
  ...
  head() {
    return {
      title: brand["a" /* default */].saas.name + ' - Blank Page'
    };
  }
